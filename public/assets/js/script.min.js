...
$(function(){function t(t){$("#flash-js").stop().hide(0).html('<span class="glyphicon glyphicon-ok" aria-hidden="true"></span> '+t).fadeIn(100).fadeOut(3500)}var a,e=$("#loader");if(navbar=$("#navbar-top").offset())var n=navbar.top;$("[name=date_start], [name=date_end]").datetimepicker({lang:"fr",format:"Y-m-d H:i:s",onChangeDateTime:function(t,a){a.attr("value",a.val()+":00")}}),$(document).on("scroll",function(t){$(this).scrollTop()>n?($("#navbar-top").addClass("navbar-fixed-top"),$("body > .container").css("margin-top",66),$("aside").css({position:"fixed",top:66})):$(this).scrollTop()<n&&($("#navbar-top").removeClass("navbar-fixed-top"),$("body > .container").css("margin-top",0),$("aside").css({position:"relative",top:0}))}),$("[data-delete-post]").on("click",function(e){var n=$("#modal-delete-post"),o=$("#loader"),i=$("button");o.css("opacity",1).fadeIn(200,function(){$.ajax({url:a.attr("action"),type:"POST",data:a.serialize(),success:function(e,d){i.attr("disabled",!1),a.parent().parent().fadeOut(200),o.fadeOut(200,function(){n.modal("hide"),t(e),a=void 0})},error:function(t,e,d){i.attr("disabled",!1),o.fadeOut(200,function(){n.modal("hide"),a=void 0})}})})}),$("[data-delete-comment]").on("click",function(e){var n=$("#modal-delete-comment"),o=$("#loader"),i=$("button");o.css("opacity",1).fadeIn(200,function(){$.ajax({url:a.attr("action"),type:"POST",data:a.serialize(),success:function(e,d){i.attr("disabled",!1),a.parent().parent().fadeOut(200),o.fadeOut(200,function(){n.modal("hide"),t(e),a=void 0})},error:function(t,e,d){i.attr("disabled",!1),o.fadeOut(200,function(){n.modal("hide"),a=void 0})}})})}),$("article.dashboard").on("submit","form.status",function(a){var e=$(this),n=$("#loader"),o=$("button");a.preventDefault(),o.attr("disabled",!0),n.css("opacity",1).fadeIn(200,function(){$.ajax({url:e.attr("action"),type:"POST",data:e.serialize(),success:function(a,e){o.attr("disabled",!1),$("tr#"+a.id).html(a.html),n.fadeOut(200,function(){t(a.message)})},error:function(t,a,e){n.fadeOut(200,function(){o.attr("disabled",!1)})}})})}).on("submit","form.delete",function(t){t.preventDefault(),a=$(this)}),$("#flash-js, #flash-php").on("mousedown",function(){$(this).stop().fadeOut(0)}),""!==$("#flash-php").html().trim()&&$("#flash-php").stop().hide(0).fadeIn(100).fadeOut(3500),$("button.ajax").click(function(){var t=$("button"),a=$(this).attr("data-url");t.attr("disabled",!0),e.css("opacity",1).fadeIn(200,function(){$.ajax({url:a,type:"GET",success:function(a,n){t.attr("disabled",!1),$("table").html(a),e.fadeOut(200)},error:function(a,n,o){t.attr("disabled",!1),e.fadeOut(200)}})})})});
