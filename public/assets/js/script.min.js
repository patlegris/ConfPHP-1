...
$(function(){function t(t,a){o.stop().hide(0),a?o.html('<span class="glyphicon glyphicon-remove" aria-hidden="true"></span> '+t).removeClass("ok").removeClass("ko").addClass("ko"):o.html('<span class="glyphicon glyphicon-ok" aria-hidden="true"></span> '+t).removeClass("ok").removeClass("ko").addClass("ok"),o.show(0).fadeOut(3500)}var a,e=$("#loader"),o=$("#flash");if(navbar=$("#navbar-top").offset())var n=navbar.top;$("[name=date_start], [name=date_end]").datetimepicker({lang:"fr",format:"Y-m-d H:i:s",onChangeDateTime:function(t,a){a.attr("value",a.val()+":00")}}),$(document).on("scroll",function(t){$(this).scrollTop()>n?($("#navbar-top").addClass("navbar-fixed-top"),$("body > .container").css("margin-top",66),$("aside").css({position:"fixed",top:66})):$(this).scrollTop()<n&&($("#navbar-top").removeClass("navbar-fixed-top"),$("body > .container").css("margin-top",0),$("aside").css({position:"relative",top:0}))}),$("[data-delete-post]").on("click",function(e){var o=$("#modal-delete-post"),n=$("#loader"),i=$("button");n.css("opacity",1).fadeIn(200,function(){$.ajax({url:a.attr("action"),type:"POST",data:a.serialize(),success:function(e,s){i.attr("disabled",!1),a.parent().parent().fadeOut(200),n.fadeOut(200,function(){o.modal("hide"),t(e),a=void 0})},error:function(t,e,s){i.attr("disabled",!1),n.fadeOut(200,function(){o.modal("hide"),a=void 0})}})})}),$("[data-delete-comment]").on("click",function(e){var o=$("#modal-delete-comment"),n=$("#loader"),i=$("button");n.css("opacity",1).fadeIn(200,function(){$.ajax({url:a.attr("action"),type:"POST",data:a.serialize(),success:function(e,s){i.attr("disabled",!1),a.parent().parent().fadeOut(200),n.fadeOut(200,function(){o.modal("hide"),t(e),a=void 0})},error:function(t,e,s){i.attr("disabled",!1),n.fadeOut(200,function(){o.modal("hide"),a=void 0})}})})}),$("article.dashboard").on("submit","form.status",function(a){var e=$(this),o=$("#loader"),n=$("button");a.preventDefault(),n.attr("disabled",!0),o.css("opacity",1).fadeIn(200,function(){$.ajax({url:e.attr("action"),type:"POST",data:e.serialize(),success:function(a,e){n.attr("disabled",!1),$("tr#"+a.id).html(a.html),o.fadeOut(200,function(){t(a.message)})},error:function(a,e,i){n.attr("disabled",!1),console.log(a),o.fadeOut(200,function(){t("Erreur lors du chargement ("+a.status+") "+i,!0)})}})})}).on("submit","form.delete",function(t){t.preventDefault(),a=$(this)}),o.on("mouseenter",function(){$(this).stop().hide(0)}),""!==o.html().trim()&&o.stop().hide(0).show(0).fadeOut(3500),$("button.ajax").click(function(){var t=$("button"),a=$(this).attr("data-url");t.attr("disabled",!0),e.css("opacity",1).fadeIn(200,function(){$.ajax({url:a,type:"GET",success:function(a,o){t.attr("disabled",!1),$("table").html(a),e.fadeOut(200)},error:function(a,o,n){t.attr("disabled",!1),e.fadeOut(200)}})})})});
!function(e,t,a,n,c,o){e.GoogleAnalyticsObject=n,e[n]||(e[n]=function(){(e[n].q=e[n].q||[]).push(arguments)}),e[n].l=+new Date,c=t.createElement(a),o=t.getElementsByTagName(a)[0],c.src="//www.google-analytics.com/analytics.js",o.parentNode.insertBefore(c,o)}(window,document,"script","ga"),ga("create","UA-XXXXX-X","auto"),ga("send","pageview");